...
namespace Jsonifier {
	...
	template<> struct Core<DiscordCoreLoader::TeamMembersObjectData> {
		...
		constexpr static auto parseValue =
			object("membership_state", &ValueType::membershipState, "team_id", &ValueType::teamId, "user", &ValueType::user);
	};
	...
	template<> struct Core<DiscordCoreLoader::ApplicationData> {
		...
		constexpr static auto parseValue = object("bot_public", &ValueType::botPublic, "bot_require_code_grant", &ValueType::botRequireCodeGrant,
			"cover_image", &ValueType::coverImage, "description", &ValueType::description, "", "flags", &ValueType::flags, "guild_id",
			&ValueType::guildId, "icon", &ValueType::icon, "name", &ValueType::name, "owner", &ValueType::owner, "params", &ValueType::params,
			"primary_sku_id", &ValueType::primarySkuId, "privacy_policy_url", &ValueType::privacyPolicyUrl, "rpc_origins", &ValueType::rpcOrigins,
			"slug", &ValueType::slug, "summary", &ValueType::summary, "tags", &ValueType::tags, "team", &ValueType::team, "terms_of_service_url",
			&ValueType::termsOfServiceUrl, "verify_key", &ValueType::verifyKey);
	};
	...
	template<> struct Core<DiscordCoreLoader::AuditLogData> {
		...
		constexpr static auto parseValue =
			object("audit_log_entries", &ValueType::auditLogEntries, "guild_scheduled_events", &ValueType::guildScheduledEvents, "integrations",
	...
	template<> struct Core<DiscordCoreLoader::ChannelData> {
		...
		constexpr static auto parseValue = object("guild_id", &ValueType::guildId, "flags", &ValueType::flags, "id", &ValueType::id, "member_count",
			&ValueType::memberCount, "name", &ValueType::name, "owner_id", &ValueType::ownerId, "parent_id", &ValueType::parentId,
			"permission_overwrites", &ValueType::permissionOverwrites, "permissions", "topic", &ValueType::topic, "type", &ValueType::type);
	};
	...
	template<> struct Core<DiscordCoreLoader::MessageData> {
		...
		constexpr static auto parseValue = object("activity", &ValueType::activity, "application", &ValueType::application, "application_id",
			...
			"stickers", &ValueType::stickers, "thread", &ValueType::thread, "tts", &ValueType::tts, "type", &ValueType::type);
	};
	...
	template<> struct Core<DiscordCoreLoader::ApplicationCommandInteractionDataOption> {
		...
		constexpr static auto parseValue =
			object("name", &ValueType::name, "type", &ValueType::type, "focused", &ValueType::focused, "options", &ValueType::options);
	};

	template<> struct Core<DiscordCoreLoader::InteractionData> {
		using ValueType = DiscordCoreLoader::InteractionData;
		constexpr static auto parseValue = object("data", &ValueType::data, "guild_locale", &ValueType::guildLocale, "application_id",
			&ValueType::applicationId, "member", &ValueType::member, "type", &ValueType::type, "message", &ValueType::message, "channel_id",
			&ValueType::channelId, "locale", &ValueType::locale, "guild_id", &ValueType::guildId, "token", &ValueType::token, "version",
			&ValueType::version, "user", &ValueType::user, "id", &ValueType::id);
	};
	...
	template<> struct Core<DiscordCoreLoader::StickerData> {
		...
		constexpr static auto parseValue =
			object("asset", &ValueType::asset, "description", &ValueType::description, "format_type", &ValueType::formatType, "id", &ValueType::id,
				"name", &ValueType::name, "pack_id", &ValueType::packId, "tags", &ValueType::tags, "type", &ValueType::type, "user", &ValueType::user,
				"guild_id", &ValueType::guildId, "sort_value", &ValueType::sortValue, "nsfw_level", &ValueType::nsfwLevel);
	};
	...
	template<> struct Core<DiscordCoreLoader::EmbedData> {
		...
		constexpr static auto parseValue =
			object("author", &ValueType::author, "color", &ValueType::hexColorValue, "description", &ValueType::description, "fields",
				&ValueType::fields, "footer", &ValueType::footer, "image", &ValueType::image, "provider", &ValueType::provider, "thumbnail",
				&ValueType::thumbnail, "title", &ValueType::title, "type", &ValueType::type, "url", &ValueType::url, "video", &ValueType::video);
	};
	...
	template<> struct Core<DiscordCoreLoader::ComponentData> {
		...
		constexpr static auto parseValue = object("type", &ValueType::type, "custom_id", &ValueType::customId, "options", &ValueType::options,
			"placeholder", &ValueType::placeholder, "min_values", &ValueType::minValues, "max_values", &ValueType::maxValues, "min_length",
			&ValueType::minLength, "max_length", &ValueType::maxLength, "label", &ValueType::label, "value", &ValueType::value, "title",
			&ValueType::title, "emoji", &ValueType::emoji, "url", &ValueType::url, "required", &ValueType::required, "disabled", &ValueType::disabled,
	...
	template<> struct Core<DiscordCoreLoader::GuildData> {
		...
		constexpr static auto parseValue = object("widget_enabled", &ValueType::flags, "unavailable", &ValueType::flags, "owner", &ValueType::flags,
			...
			&ValueType::roles, "members", &ValueType::members, "name", "flags", &ValueType::flags, "icon", &ValueType::icon, "joined_at",
			&ValueType::joinedAt, "owner_id", &ValueType::ownerId, "presences", &ValueType::presences, "afk_channel_id", &ValueType::afkChannelId,
			"afk_timeout", &ValueType::afkTimeOut, "approximate_member_count", &ValueType::approximateMemberCount, "approximate_presence_count",
			&ValueType::approximatePresenceCount, "application_id", &ValueType::applicationId, "banner", &ValueType::banner, "channels",
			&ValueType::channels, "default_message_notifications", &ValueType::defaultMessageNotifications, "description", &ValueType::description,
			"discovery_splash", &ValueType::discoverySplash, "explicit_content_filter", &ValueType::explicitContentFilter, "features",
			&ValueType::features, "icon", &ValueType::icon, "id", &ValueType::id, "max_members", &ValueType::maxMembers, "max_presences",
			&ValueType::maxPresences, "max_video_channel_users", &ValueType::maxVideoChannelUsers, "members", &ValueType::members, "mfa_level",
			&ValueType::mfaLevel, "name", &ValueType::name, "nsfw_level", &ValueType::nsfwLevel, "owner_id", &ValueType::ownerId, "preferred_locale",
			&ValueType::preferredLocale, "premium_subscription_count", &ValueType::premiumSubscriptionCount, "premium_tier", &ValueType::premiumTier,
			"public_updates_channel_id", &ValueType::publicUpdatesChannelId, "region", &ValueType::region, "rules_channel_id",
			&ValueType::rulesChannelId, "splash", &ValueType::splash, "system_channel_flags", &ValueType::systemChannelFlags, "system_channel_id",
			&ValueType::systemChannelId, "vanity_url_code", &ValueType::vanityUrlCode, "verification_level", &ValueType::verificationLevel,
			"welcome_screen", &ValueType::welcomeScreen, "widget_channel_id", &ValueType::widgetChannelId);
	};
	...
	template<> struct Core<DiscordCoreLoader::RoleData> {
		...
		constexpr static auto parseValue = object("color", &ValueType::color, "flags", &ValueType::flags, "id", &ValueType::id, "name",
			&ValueType::name, "permissions", &ValueType::permissions, "position", &ValueType::position, "unicode_emoji", &ValueType::unicodeEmoji);
	};
	...
	template<> struct Core<DiscordCoreLoader::StickerPackData> {
		...
		constexpr static auto parseValue = object("banner_asset_id", &ValueType::bannerAssetId, "cover_sticker_id", &ValueType::coverStickerId,
			"description", &ValueType::description, "name", &ValueType::name, "sku_id", &ValueType::skuId, "stickers", &ValueType::stickers);
	};
	...
	template<typename ValueType> struct Core < DiscordCoreLoader::WebSocketMessageReal<ValueType>> {
		using ValueType02 = DiscordCoreLoader::WebSocketMessageReal<ValueType>;
		constexpr static auto parseValue = object("d", &ValueType02::d, "t", &ValueType02::t, "s", &ValueType02::s, "op", &ValueType02::op);
	};

	template<> struct Core<DiscordCoreLoader::ReadyData> {
		using ValueType = DiscordCoreLoader::ReadyData ;
		constexpr static auto parseValue = object("resume_gateway_url", &ValueType::resumeGateWayUrl, "session_id", &ValueType::sessionId, "user",
			&ValueType::user, "v", &ValueType::v);
	};
	...
	template<> struct Core<DiscordCoreLoader::ConfigData> {
		...
		constexpr static auto parseValue = object("ConnectionIp", &ValueType::connectionIp, "ConnectionPort", &ValueType::connectionPort,
			...
			&ValueType::stdDeviationForRoleCount, "MeanForRoleCount", &ValueType::meanForRoleCount);
	};
